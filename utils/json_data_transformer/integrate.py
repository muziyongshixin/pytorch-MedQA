...
# 将多个文件的数据合并到一个文件里，同时将text和question里的句子进行分词
file_list = ["renwei_exam_2017_correct_ESresult.txt.600"]
out_file_name=path+'temp/test.txt'
...
if __name__ == '__main__':
    # integrate_files()
    split_train_and_dev_dataset(file_path="/m/liyz/MedQA-workspace/rawdata/full_data/temp/train&dev.txt",
                                train_path="train_290000.json",
                                dev_path="dev_xxxx.json",
                                train_num=290000,
                                dev_num=0)
# integrate_files()
